...
% Load plant (method 1)
plant = NonLinearODE(dim,nI,@dynamics_func,reachTimeStep,controlPeriod,outputMat); % User specifies all matrices and time step (Ts)
...
% If procedure == verify, generate and execute the following
